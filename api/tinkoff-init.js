// /api/tinkoff-init.js — FIXED BACKEND FOR VERCEL + TINKOFF DEMO MODE
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ---- CORRECT DEMO SIGNATURE FORMAT ----
    // DEMO RULE = SHA256(OrderId + Amount + TerminalKey + SecretKey)
